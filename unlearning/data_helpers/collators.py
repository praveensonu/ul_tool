...
def ForgetCollator(samples): # for vanilla gradient ascent and finetuning
    """
...
def RetainCollator(samples): # for vanilla/cyclic gradient difference, also can be extended to dpo, npo type
    """
